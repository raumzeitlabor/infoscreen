...
function loadGraph()
{
	...
	switch ($type) {
		case 'stromverbrauch':
			...
			break;
		case 'mitglieder':
			$imgname = "https://api.cosm.com/v2/feeds/42055/datastreams/Mitglieder.png?width=450&height=130&c=ff33ff&duration=30days&title=Mitglieder&stroke_size=2&show_axis_labels=true&detailed_grid=true&scale=auto&timezone=Berlin&v=1395676268666";
			break;
		case 'payback':
