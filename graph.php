...
function loadGraph()
{
	...
	switch ($type) {
		case 'stromverbrauch':
			$imgname = "https://api.cosm.com/v2/feeds/42055/datastreams/Strom_Leistung.png?width=500&height=200&c=ff33ff&duration=30minutes&title=Stromverbrauch&stroke_size=2&show_axis_labels=true&detailed_grid=true&scale=auto&timezone=Berlin&v=1395676268666";
			break;
		case 'temperatur':
			$imgname = "https://api.cosm.com/v2/feeds/42055/datastreams/Temperatur_Raum_Beamerplattform.png?width=500&height=200&c=ff33ff&duration=3hours&title=Temperatur&stroke_size=2&show_axis_labels=true&detailed_grid=true&scale=auto&timezone=Berlin&v=1395676268666";
			break;
		case 'payback':
